...
test('Searches the news and returns formatted articles', async t => {
	...
	const expectedArticle1 = {
		...
		shortLink: 'http://www.cnn.com/travel/article/world-best-foods-readers-choice/index.html'
	};
	...
	const expectedArticle2 = {
		...
		shortLink: 'http://www.cnn.com/travel/article/best-korean-dishes/index.html'
	};
